...
""",
  ...
  def testPathsWithSlashes(self):
    ...
    golden_printed = [
      ...
      'Unexpected trailing "/"',
      'complete err:',
      # This error still proves that complete handles project paths with slashes:
      'Cannot mark complete because a descendant action is incomplete: <action uid=9 is_deleted="True" is_complete="False" name="A0" ctx=""/>',
      'rmprj:',
      'ls11:',
      '--project-- uid=1 --incomplete-- ---active--- inbox',
      '--folder--- uid=4 F0',
